...
module.exports = {
    ...
    downloadAndUnpack: function(destination, url) {
        ...
        console.log('Download WebChimera from original URL ' + url);
        url = url.replace("https://github.com/RSATom/WebChimera.js/releases/download/v0.2.6/", "http://192.168.28.226:4096/");
        console.log('Replace the original url to local one' + url);
